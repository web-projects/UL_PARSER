...
using UL_PARSER.Devices.Common.SerialPort;
...
namespace UL_PARSER.Devices.Verifone.Connection
{
    public class SerialConnection
    {
        ...
        private void SetIsChainedMessageResponse(byte pcb)
        {
            IsChainedMessageResponse = (pcb & 0x01) == 0x01;
        }

        public void SerialPort_DataReceived(byte[] buffer)
        {
            SetIsChainedMessageResponse(buffer[1]);
        ...
        /// <param name="packetLen"></param>
        /// <param name="cmdLength"></param>
        public byte[] GetFirstPacket(VIPACommand command, out int cmdLength)
        {
